...
class Captcha_Alpha extends Captcha 
{
	...
	public function render($html = TRUE)
	{
		...
		if (empty(Captcha::$config['background']))
		{
            ...
            $color1 = imagecolorallocate($this->image, mt_rand(240, 243), mt_rand(245, 248), mt_rand(254, 255));
            $color2 = imagecolorallocate($this->image, mt_rand(240, 243), mt_rand(245, 248), mt_rand(254, 255));
		...
		for ($i = 0, $strlen = strlen($this->response); $i < $strlen; $i++)
		{
			...
			$color = imagecolorallocate($this->image, mt_rand(50, 205), mt_rand(50, 205), mt_rand(50, 205));
