...
<?if(isset($item)){?>
    <?=Form::open('admin/services/add/'.$parent_id.'/'.'add'.'/'.$item->id, array('enctype' => 'multipart/form-data'))?>
<?} else{?>
    <?=Form::open('admin/services/add/'.$parent_id, array('enctype' => 'multipart/form-data'))?>
<?}?>
